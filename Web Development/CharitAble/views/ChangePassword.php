		...
		<div class="sfp">
			...
			<div class="mainfp">
				...
				<div class="fp-form">
					...
					<form action="../controller/ChangePasswordAction.php" method="POST" onsubmit="return(validateChangePasswordForm(this));">
						<label for="opass"><span class="flll">Old Password</span></label><br>
						...
						<br><br><br>
						<input type="submit" value="RESET" class="csubmit">
					</form>
